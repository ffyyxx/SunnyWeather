...
private val sky = mapOf(
        ...
        "PARTY_CLOUDY_NIGHT" to Sky("多云",R.drawable.ic_partly_cloud_night,R.drawable.bg_partly_cloudy_night),
        ...
        "HALT" to Sky("冰雹",R.drawable.ic_hail,R.drawable.bg_snow),
